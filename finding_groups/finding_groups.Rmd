---
title: "Business Analytics - Finding Groups Within the Data"
author: "Ming-Yu Liu"
date: "`r Sys.Date()`"
output:
...
This wraps up our example of where clustering algorithms can be used to improve your businesses efficiency. You can find all the code (finding_groups.R) and datasets (in the data folder) used in this documentation [here](https://github.com/ethen8181/Business-Analytics/tree/master/finding_groups).
