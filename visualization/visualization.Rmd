---
title: "Collection of Visualization"
date: "`r Sys.Date()`"
author: "Ming-Yu Liu"
output:
...
Articles related to producing informative visualization.

# Avoiding Pie Charts

Date: 2016.3.16

The purpose of a pie chart is to show the relationship of parts out of a whole. With that being said they can still be really bad at the one thing they're ostensibly designed to do. Consider the following pie chart from the [Wall Street Journal](http://www.wsj.com/articles/what-data-scientists-do-all-day-at-work-1457921541) article on What Data Scientists Do All Day at Work.

<img src = "/Users/ethen/Business-Analytics/visualization/avoid_pie_charts/data_scientist.png" width = "400" height = "800" >
...
library(ggthemes)
library(data.table)
setwd("/Users/ethen/Business-Analytics/visualization/avoid_pie_charts")
d <- fread("pie.txt")
...
**Sources:** source code can be obtained [here](https://github.com/ethen8181/Business-Analytics/blob/master/visualization/avoid_pie_charts/pie.R).

## Reference 

1. Worst Chart In The World: http://www.businessinsider.com/pie-charts-are-the-worst-2013-6
2. How to replace a pie chart: http://varianceexplained.org/r/improving-pie-chart/
3. Take the Pies out of Pi Day: http://rud.is/b/2016/03/14/spinning-cycles-in-box-4-to-take-the-pies-out-of-pi-day/
