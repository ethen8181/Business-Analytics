...
Note that the formula listed in this section is used when the **two groups are independent of one another (not paired)**. e.g. If we wish to compare pre- (beginning of semester) and post-test (end of semester) scores of students, then this will require a **paired t-test**. The following video explains it nicely. [Youtube: The Paired-Difference t Procedure](https://www.youtube.com/watch?v=TMRBGFIj0RM)
...
- [Youtube: The Paired-Difference t Procedure](https://www.youtube.com/watch?v=TMRBGFIj0RM)
